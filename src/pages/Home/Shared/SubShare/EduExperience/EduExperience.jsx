        ...
        <div className="grid grid-cols-1  md:grid-cols-2 gap-10">
          ...
          <div className="bg-yellow-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-600">
                During my time at Digha High School, I developed a strong
                foundation in science and honed my analytical skills. This
                experience has prepared me for higher education and future
              ...
              <ul className="list-disc list-inside mt-2">
                <li className="text-gray-600">
                  Worked on project X, which involved...
                </li>
                {/* Add more bullet points for job responsibilities */}
              </ul>
            </div>
          </div>
          <div className="bg-yellow-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
